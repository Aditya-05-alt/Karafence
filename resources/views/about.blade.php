    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 -mt-10 relative z-10">
        ...
        <div class="bg-secondary dark:bg-gray-800 rounded-2xl shadow-lg p-10 mb-24 text-white">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-white/20">
                <div>
                    <span class="block text-4xl md:text-5xl font-display text-primary mb-2">15+</span>
                    <span class="uppercase text-sm tracking-widest text-gray-300">Years of History</span>
                </div>
                <div>
                    <span class="block text-4xl md:text-5xl font-display text-primary mb-2">50+</span>
                    <span class="uppercase text-sm tracking-widest text-gray-300">Black Belts</span>
                </div>
                <div>
                    <span class="block text-4xl md:text-5xl font-display text-primary mb-2">8</span>
    ...
    <div class="md:col-start-2 bg-surface-light dark:bg-surface-dark rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow border border-gray-100 dark:border-gray-700 group">
        ...
        <div class="p-6">
            <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4">
                A former national champion, Sensei Animesh Mondal specializes in kumite (sparring) and self-defense techniques. He leads our youth competition team.
            </p>
            ...
            <div class="bg-secondary text-white rounded-2xl overflow-hidden shadow-2xl flex flex-col lg:flex-row dark:bg-gray-800">
                <div class="lg:w-1/2 relative h-64 lg:h-auto">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div class="border-4 border-[#FBE6C4] p-6 rotate-3">
                            <h3 class="text-4xl font-display uppercase tracking-widest text-[#FBE6C4] text-center">Since<br/>2012</h3>
                        </div>
                    </div>
                </div>
                <div class="lg:w-1/2 p-10 lg:p-16 flex flex-col justify-center">
                    ...
                    <p class="text-gray-300 mb-6 leading-relaxed">
                        Karafence Academy was established in a Jatra Suru Sangha in 2012. What started as a humble gathering of five students passionate about the art of self-defense has grown into a premier institution for martial arts excellence.
                    </p>
